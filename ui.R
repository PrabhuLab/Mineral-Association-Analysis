...
#data(world.cities)
#world.cities
#leaflet(world.cities %>% dplyr::filter(country.etc == "Poland",pop>100000))
...
leaflet_map <- leafletOutput("mymap",height = "1300px", width = "100%")
...
body <- dashboardBody(
       ...
       box(width = 12, plot)),
       tabItem("map",box(title = "Map",id = "mymap",status = "info", width = "100%",leaflet_map)),
